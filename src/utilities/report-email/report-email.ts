...
export default class HTMLEmailRepportCustom{
...
//         console.log("Lien 1");
        ...
        // Add informaiton test case to list test case
        for(let i= 0; i<testSuites.length;i++){
            ...
            for (let j = 0; j < testCaseinSuite.length ; j++){
                ...
                if (testCaseinSuite[j].firstChild == null){
                    ...
                    temReportMess+= ConfigReport.getBugErrorMessage(testCase.id, temReportMess)
