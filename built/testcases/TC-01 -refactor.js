...
const home_page_2 = __importDefault(require("@page-objects/home-page"));
describe('Login suite TC01', function () {
    ...
    let homePage = new home_page_2.default();
    let loginPageRefactor;
    ...
    it('TC01- User can login into Raiway with valid username and password', () => __awaiter(this, void 0, void 0, function* () {
        loginPageRefactor = yield homePage.goToLoginPage();
        console.log("Refactor");
        yield loginPageRefactor.login(test_run_info_1.default.USERNAME, test_run_info_1.default.PASSWORD);
    }));
