...
describe('Book Ticket TC01', function () {
    ...
    beforeEach(() => __awaiter(this, void 0, void 0, function* () {
        yield logger_1.Logger.write(logger_1.FunctionType.TESTCASE, `TC12- User can book many tickets at a time`);
        homePage = home_page_1.default.getHomePageInstance();
    }), test_run_info_1.default.conditionTimeout);
    it('TC02- User can book many tickets at a time', () => __awaiter(this, void 0, void 0, function* () {
        ...
        ticket.initTicket(general_1.Station.NHATRANG, general_1.Station.SAIGON, general_1.SeatType.SOFTBEDWITHAIR, 5);
        yield bookTickePage.getBookTicket(ticket);
        expect(yield bookTickePage.getBookTicketMessage()).toBe(expectedMsg, "Could not get book many ticket");
    }));
...
//# sourceMappingURL=TC-012 copy.js.map