...
describe('ChangePassword suite - TC09', function () {
    ...
    beforeEach(() => __awaiter(this, void 0, void 0, function* () {
        yield logger_1.Logger.write(logger_1.FunctionType.TESTCASE, `TC09- User can't change password when "New Password" and "Confirm Password" are different.`);
        homePage = home_page_1.default.getHomePageInstance();
    }), test_run_info_1.default.conditionTimeout);
    it('TC09- User can not change password when "New Password" and "Confirm Password" are different.', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield changePasswordPage.changePassword(test_run_info_1.default.PASSWORD, newPass, test_run_info_1.default.PASSWORD);
...
//# sourceMappingURL=TC-09 copy.js.map