...
describe('ChangePassword suite - TC10', function () {
    ...
    beforeEach(() => __awaiter(this, void 0, void 0, function* () {
        yield logger_1.Logger.write(logger_1.FunctionType.TESTCASE, `TC10- User can't create account with "Confirm password" is not the same with "Password"`);
        homePage = home_page_1.default.getHomePageInstance();
    }), test_run_info_1.default.conditionTimeout);
    it('TC10- User can not create account with "Confirm password" is not the same with "Password"', () => __awaiter(this, void 0, void 0, function* () {
