...
describe('Login suite - TC02', function () {
  ...
  it('Login page displays when un-logged User clicks on Book ticket tab', async () => {
            ...
            // 4. Click on "Login" button
            // VP. You must specify a username displayed.
            // string actualMesg = "";
            // for (int i = 0; i < 4; i++)
            // {
            //     loginPage.Login("liennguyenlogigear12@gmail.com", "liennguyen").GetNonpasswordmessage();
            // }
            // actualMesg = loginPage.Login("liennguyenlogigear12@gmail.com", "liennguyen").GetNonpasswordmessage();
            // string expectedMsg = "You have used 4 out of 5 login attempts. After all 5 have been used, you will be unable to login for 15 minutes.";
            // Assert.AreEqual(expectedMsg, actualMesg, "Test case is failed");
