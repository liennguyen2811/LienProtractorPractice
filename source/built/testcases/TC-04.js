...
describe('Login suite - TC02', function () {
    ...
    it('Login page displays when un-logged User clicks on Book ticket tab', () => __awaiter(this, void 0, void 0, function* () {
        ...
        expect(yield loginPage.checkNonPassWordWithValidInfo(test_run_info_1.default.USERNAME, test_run_info_1.default.PASSWORD)).toBe(expectedMsg, "Login page does not display");
    }));
